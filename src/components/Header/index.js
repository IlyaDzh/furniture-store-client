            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-md-4 d-flex justify-content-center">
                        <Link to="/">
                            <img className="img-fluid pt-3 pb-3" src={logo} alt="Logo" />
                        </Link>
                    </div>
            ...
            <div className="products-mob">
                <Container>
                    <BaseNavbar expand="md">
                        <BaseNavbar.Toggle className="products-mob__button" aria-controls="basic-navbar-nav">
                            Каталог мебели
                        </BaseNavbar.Toggle>
                        <BaseNavbar.Collapse id="basic-navbar-nav">
                            <Nav className="mr-auto">
                                {catalogJSON.top
                                    && catalogJSON.top.map(item => (
                                        <Link key={item.id} className='nav-link' to={`/catalog/${item.id}`}>{item.title}</Link>
                                    ))
                                }
                                {catalogJSON.bottom
                                    && catalogJSON.bottom.map(item => (
