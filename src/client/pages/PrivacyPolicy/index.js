...
const PrivacyPolicy = () => (
    <Section>
        <div className="privacy-policy">
            ...
            <p>
                Настоящим в соответствии с Федеральным законом № 152-Ф3 о
                ...
                персональных данных ООО «ФКМ» (ОГРН(ИП) 1137746834444, ИНН
                7728855300), зарегистрированным в соответствии с законодательством РФ
                по адресу: г. Москва, ул. Островитянова, д. 9 корп.4. Персональные
            ...
            <p>
                ...
                обезличивание, передана третьим лицам для указанных ниже целей, а
            ...
            <p>
                Данное согласие дается Оператору и третьему(им) лицу(ам) ФГУП Почта
                России, ПАО Сбербанк для обработки моих персональных данных в
                следующих целях:
            </p>
            <ul>
            ...
            <p>
                ...
                соответствующего уведомления на электронный адрес info@fkm.ru. В
                случае отзыва мною согласия на обработку персональных данных Оператор
                вправе продолжить обработку персональных данных без моего согласия
                при наличии оснований указанных в пунктах 2-11 части 1 статьи 6,
                части 2 статьи 10 и части 2 статьи 11 Федерального закона №152-Ф3 «О
